...
'''
Either we generate the tuple using u = tuple("1") and then go eat some beans and plantain
or we add a comma at the end of the single element just so it becomes iterable
'''
print_tuple(u)
